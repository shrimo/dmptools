...
list of methods:
    ...
    setPerspSetting
    setUserSetting
    setViewport2Renderer
    setWireframe
    shortestEdgePath
    shortestEdgePathRelease
    softEdgeSelection
    switchColors
    switchHighlightedSelection
    switchLight
    switchObjectTumble
    switchSelectNgones
    ...
    switchShaders
    toggleNormals
    toggleVertexColorDisplay
    transferVertices
    tweakMultiComponents
    undoQueue
    unfoldAndRotate
    unselectAll
    unwrapTerrain
