...
m.addCommand('Other/Unselect All', 'import dmptools.utils.nukeCommands as nukeCommands ; nukeCommands.unselectAll();nukeCommands.closeAllControlPanel()', "Ctrl+Space")
